...
public class EhcacheConfiguration implements CacheClientConfiguration {
	...
	private void ensureEhcacheVersion() throws InitializingException {
		try {
			...
			throw new InitializingException("Ehcache version is too low, please upgrade to version 2.5.2 or above", e);
		}
	}
