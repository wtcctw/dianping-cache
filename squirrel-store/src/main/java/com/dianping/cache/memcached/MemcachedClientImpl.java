...
import com.dianping.cache.util.RetryLoop;
import com.dianping.cache.util.RetryLoop.RetryResponse;
...
public class MemcachedClientImpl implements CacheClient, Lifecycle, KeyAware, InitialConfiguration {
	...
	public void asyncRemoveBackupKey(String key, boolean isHot, String category) throws CacheException {
