...
public class DangaClientFactory {
    ...
    private static final String CORESIZEOFTHREADPOOL = "avatar-cache.danga.coresize";
    private static final int DEFAULT_CORE_SIZE = 5;

    private static final String MAXSIZEOFTHREADPOLL = "avatar-cache.danga.maxsize";
    ...
    private static int coreSize = configManager.getIntValue(CORESIZEOFTHREADPOOL, DEFAULT_CORE_SIZE);
    private static int maxSize = configManager.getIntValue(MAXSIZEOFTHREADPOLL, DEFAULT_MAX_SIZE);
